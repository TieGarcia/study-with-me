...
public class SettingsRepository {
	...
	private static final String UPDATE_SQL = "UPDATE web_setting SET content = ?, updatedBy = ?, types = ?, image = ? WHERE id = ?";
	...
	public boolean create(SettingsModelRequest request, String username) {
		...
		try (Connection connection = DBUtil.getConnection();
			...
			preparedStatement.setString(4, request.getTypes());
	...
	public boolean update(Long id, SettingsModelRequest request, String username) {
		...
		try (Connection connection = DBUtil.getConnection();
			...
			preparedStatement.setString(1, request.getContent());
			preparedStatement.setString(2, username);	
			preparedStatement.setString(3, request.getTypes());
	...
	public SettingsModelResponse getById(Long id) {
		...
		try (Connection connection = DBUtil.getConnection();
			...
			while (rs.next()) {
				...
				response.setTypes(rs.getString("types"));
