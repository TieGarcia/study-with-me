    ...
    <div class="card card-primary">
      ...
      <div class="card-body">
        ...
        <div class="form-group">
          <label for="name">Title</label> <input class="form-control" placeholder="Content" id="inpPostsTitle">
        </div>
...
<script src="${pageContext.request.contextPath}/page-admin/features/websettings/index.js"></script>